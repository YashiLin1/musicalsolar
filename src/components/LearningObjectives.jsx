      ...
      <img className="logo-img mb-6" src="/image/neroart.png" />
        ...
        <div className="grid lg:grid-cols-3 gap-10">
          <div className="learn-board py-8 px-6 mb-4">
            ...
            Solving problem in Computer Science is about breaking a problem down into smaller parts to solve it. When you break complex rhythms into single beat to complete the challenge one step at a time and recognize pattern of the planets, you are developing the skill! Using logical reasoning to solve problems is a fundamental mindset in Computer Science! 
            </p>
          </div>
          ...
          <div className="learn-board py-8 px-6 mb-4">
            ...
            <p className="text-lg font-light text-gray-200 max-w-3xl leading-[2rem] ">
              There are different combinations to create the same rhythms. 
              Being creative is important in Computer Science!
              The key to composing lies in your perspective. Try to understand how the rhythm is affected when the String is not at 0° degree, or when
